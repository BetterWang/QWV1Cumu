...
config.General.requestName = 'HIMB5_V1Cumu_ppReco_eta08_eff_v3'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_V1_PbPb15_ppReco_GMO_eta08_v1.py'
...
## HIMB6
config.General.requestName = 'HIMB6_V1Cumu_ppReco_eta08_eff_v3'
...
## HIMB7
config.General.requestName = 'HIMB7_V1Cumu_ppReco_eta08_eff_v3'
